...
append_once "lxc.mount.entry: /dev/sg1 dev/sg1 none bind,optional,create=file" "$CONF"
...
echo "  5. ./scripts/setup-homelab.sh    # Automated setup with password generation"
echo "  6. ./ct/install-service.sh       # Optional: Enable auto-start on boot"
